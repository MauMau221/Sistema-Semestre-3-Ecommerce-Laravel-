                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 2" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 3" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 4" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 5" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 6" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 7" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card product-card border-0">
                            <div class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="/css/image/card/image.png" alt="Camiseta 8" class="card-img-top">
                                </a>
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
