                    ...
                    <div class="card-body">
                                        ...
                                        <div class="card h-100 border rounded overflow-hidden">
                                            <div class="position-relative">
                                                ...
                                                <div style="height: 140px; background-color: #f8f9fa; position: relative;">
                                                    ...
                                                    <div class="position-absolute bottom-0 start-0 bg-danger text-white px-2 py-1"
                                                        style="font-size: 0.75rem; border-top-right-radius: 8px; z-index:2; min-width: 48px; text-align: center;">
                                                        -{{ $desconto }}%
                                                    </div>
                                                    <div
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Explore nossos produtos e adicione itens aos favoritos clicando no
                                    ícone de coração.</p>
