...
<div class="container py-4">
    <h2 class="mb-4">Adicionar Novo Endereço</h2>
                ...
                <div class="card-body">
                    <form action="{{ route('user.addresses.store') }}" method="POST">
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="endereco_principal" name="endereco_principal" value="1" {{ old('endereco_principal') ? 'checked' : '' }}>
                            <label class="form-check-label" for="endereco_principal">Definir como endereço principal</label>
                        </div>
                        
                        <div class="d-flex mt-4">
                            <button type="submit" class="btn btn-dark me-2">Salvar Endereço</button>
